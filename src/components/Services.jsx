            ...
            <div className="flex flex-col w-4/5 mx-auto justify-around items-center">
                ...
                <div className="flex">
                    ...
                    <div data-aos="fade-up" data-aos-duration="500" className="flex flex-col w-1/3 ml-7">
                        ...
                        <h1 className="text-lg font-poppins font-normal text-gray-600">
                        Our OCD detection services employ machine learning algorithms detect Obsessive-Compulsive Disorder. Through the analysis of diverse factors including demographic information and symptom severity, our platform enables accurate identification of OCD.
                        </h1>
